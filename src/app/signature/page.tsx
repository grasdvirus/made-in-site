...
import { Mail, Phone, Link2, Loader2, Instagram, Youtube } from 'lucide-react';
        ...
        <div className="text-center mb-12">
         ...
         {isLoading ? (
            ...
            <Card className="overflow-hidden">
                ...
                <CardFooter className="bg-muted/50 p-4 flex justify-center gap-2 flex-wrap">
                    ...
                    {settings.instagramUrl && <Button asChild variant="ghost" size="icon"><Link href={settings.instagramUrl} target="_blank" rel="noopener noreferrer"><Instagram className="w-5 h-5"/></Link></Button>}
                    {settings.whatsappUrl && <Button asChild variant="ghost" size="icon"><Link href={settings.whatsappUrl} target="_blank" rel="noopener noreferrer"><WhatsAppIcon className="w-5 h-5 fill-current"/></Link></Button>}
                    {settings.tiktokUrl && <Button asChild variant="ghost" size="icon"><Link href={settings.tiktokUrl} target="_blank" rel="noopener noreferrer"><TikTokIcon className="w-5 h-5 fill-current"/></Link></Button>}
                    {settings.youtubeUrl && <Button asChild variant="ghost" size="icon"><Link href={settings.youtubeUrl} target="_blank" rel="noopener noreferrer"><Youtube className="w-5 h-5"/></Link></Button>}
                </CardFooter>
            </Card>
        ) : (
