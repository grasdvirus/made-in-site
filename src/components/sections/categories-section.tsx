...
const categories = [
    { name: "FEMMES", image: "https://picsum.photos/400/500?random=1", hint: "woman fashion" },
    { name: "MONTRES", image: "https://picsum.photos/400/500?random=2", hint: "luxury watch" },
    { name: "HOMMES", image: "https://picsum.photos/400/500?random=3", hint: "man fashion" },
    { name: "SACS", image: "https://picsum.photos/400/500?random=4", hint: "handbag" }
];
