    ...
    <footer className="bg-card border-t">
      <div className="py-16 px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li><Link href="#" className="hover:text-foreground">Mode Homme</Link></li>
            <li><Link href="#" className="hover:text-foreground">Mode Femme</Link></li>
            <li><Link href="#" className="hover:text-foreground">Mode Enfant</Link></li>
            <li><Link href="#" className="hover:text-foreground">Nos Collections</Link></li>
          </ul>
        </div>
        <div>
          <h5 className="font-bold mb-4">SUPPORT</h5>
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li><Link href="#" className="hover:text-foreground">Retourner un produit</Link></li>
            <li><Link href="#" className="hover:text-foreground">Politique de remboursement</Link></li>
            <li><Link href="#" className="hover:text-foreground">Suivre une commande</Link></li>
            <li><Link href="#" className="hover:text-foreground">Nous contacter</Link></li>
          </ul>
        </div>
        <div>
          <h5 className="font-bold mb-4">À PROPOS</h5>
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li><Link href="#" className="hover:text-foreground">Qui nous sommes</Link></li>
            <li><Link href="#" className="hover:text-foreground">Politique de retour et de remboursement</Link></li>
      ...
      <div className="py-6 px-6 md:px-10 border-t flex flex-col sm:flex-row justify-between items-center text-sm text-muted-foreground">
        <div className="flex space-x-4 mb-4 sm:mb-0">
          ...
          <Link href="#" className="hover:text-foreground">Conditions de service</Link>
        </div>
